...
public class Blue_Soul_Egg extends Item{

	Blue_Soul_Egg(String name)
	{
		this.setUnlocalizedName(name);
		this.setTextureName("silkspawners:egg_blue_soul");
    ...
    public String getItemStackDisplayName(ItemStack stack)
    {
        ...
        {
            String a = ("" + StatCollector.translateToLocal(MainJava.egg_blue_soul.getUnlocalizedName() + ".name")).trim();
            return a;
        }
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    if (world.getBlock(i, j, k) instanceof BlockLiquid && world.getBlock(x, y, z).getMaterial() == Material.water)
                    {
                   	 NBTTagCompound nbt = stack.getTagCompound();
                     world.setBlock(x, y, z, MainJava.WaterSpawner);
                     TileEntity tile = world.getTileEntity(x, y, z);
